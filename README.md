...
from anywhere in the world. The data for PV power production is retrieved from an external website.
...
No software licences to be paid, all things are freely available. 
The course is intended to be taught and not primarily for self study. 
All programming examples are included - step by step.
